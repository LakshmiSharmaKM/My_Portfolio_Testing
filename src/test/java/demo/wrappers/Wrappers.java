...
public class Wrappers {
    ...
    public static void dropDownClick(ChromeDriver driver, String dropDownText) {
        try {
            WebElement element = driver.findElement(
                    By.xpath("//div[contains(@class,'QXL7Te')]//div[@data-value='" + dropDownText + "']"));
            element.click();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getdateSevenDaysAgo() {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy"); // Format the current date
